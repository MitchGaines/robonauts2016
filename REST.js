...
REST_ROUTER.prototype.handleRoutes = function(router, connection, md5)
{
        ...
        router.post('/parse-data', function(req, res) {
            ...
            var matches_sql_v2 = "INSERT INTO matches(team_number, match_number, a1_successful, a2_successful, b1_successful, b2_successful, c1_successful, c2_successful, d1_successful, d2_successful, lb_successful, a1_failed, a2_failed, b1_failed, b2_failed, c1_failed, c2_failed, d1_failed, d2_failed, lb_failed, a1_attempts, a2_attempts, b1_attempts, b2_attempts, c1_attempts, c2_attempts, d1_attempts, d2_attempts, lb_attempts, a1_total, a2_total, b1_total, b2_total, c1_total, c2_total, d1_total, d2_total, lb_total, a1_assists, a2_assists, b1_assists, b2_assists, c1_assists, c2_assists, d1_assists, d2_assists, lb_assists, a1_stuck, a2_stuck, b1_stuck, b2_stuck, c1_stuck, c2_stuck, d1_stuck, d2_stuck, lb_stuck, auton_floor_intake, auton_defense_crossed, auton_defense_total, auton_defense_assisted, auton_defense_stuck, auton_high, auton_high_missed, auton_low, auton_low_missed, auton_reach, auton_score, tele_high_made, tele_high_missed, tele_forced_miss, tele_low_made, tele_low_missed, tele_hp_high_intake, tele_hp_high_intake_dropped, tele_floor_intake, tele_knock_out, tele_hang, tele_hang_failed, tele_challenge, tele_challenge_failed, driver_rating, bully_rating, fouls_noticed, contributed_score) VALUES  ('"+ team_number +"', '"+ match_number +"', '"+ a1_success +"', '"+ a2_success +"', '"+ b1_success +"', '"+ b2_success +"', '"+ c1_success +"', '"+ c2_success +"', '"+ d1_success +"', '"+ d2_success +"', '"+ lb_success +"', '"+ a1_failed +"', '"+ a2_failed +"', '"+ b1_failed +"', '"+ b2_failed +"', '"+ c1_failed +"', '"+ c2_failed +"', '"+ d1_failed +"', '"+ d2_failed +"', '"+ lb_failed +"', '"+ a1_attempts +"', '"+ a2_attempts +"', '"+ b1_attempts +"', '"+ b2_attempts +"', '"+ c1_attempts +"', '"+ c2_attempts +"', '"+ d1_attempts +"', '"+ d2_attempts +"', '"+ lb_attempts +"', '"+ a1_total +"', '"+ a2_total +"', '"+ b1_total +"', '"+ b2_total +"', '"+ c1_total +"', '"+ c2_total +"', '"+ d1_total +"', '"+ d2_total +"', '"+ lb_total +"', '"+ a1_assists +"', '"+ a2_assists +"', '"+ b1_assists +"', '"+ b2_assists +"', '"+ c1_assists +"', '"+ c2_assists +"', '"+ d1_assists +"', '"+ d2_assists +"', '"+ lb_assists +"', '"+ a1_stuck +"', '"+ a2_stuck +"', '"+ b1_stuck +"', '"+ b2_stuck +"', '"+ c1_stuck +"', '"+ c2_stuck +"', '"+ d1_stuck +"', '"+ d2_stuck +"', '"+ lb_stuck +"', '"+ auton_floor_intake +"', '"+ auton_defense_crossed +"', '"+ auton_defense_total +"', '"+ auton_defense_assisted +"', '"+ auton_defense_stuck +"', '"+ auton_high_made +"', '"+ auton_high_missed +"', '"+ auton_low_made +"', '"+ auton_low_missed +"', '"+ auton_reach +"', '"+ auton_score +"', '"+ high_made +"', '"+ high_missed +"', '"+ forced_miss +"', '"+ low_made +"', '"+ low_missed +"', '"+ hp_intake +"', '"+ hp_intake_dropped +"', '"+ floor_intake +"', '"+ knockouts +"', '"+ hang +"', '"+ hang_failed +"', '"+ challenge +"', '"+ challenge_failed +"', '"+ driver_rating +"', '"+ bully_rating +"', '"+ fouls_noticed +"', '"+ contributed_score +"')";
